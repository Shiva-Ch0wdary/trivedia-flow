...
const PortfolioManagement: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Migration Notice */}
      <Card className="bg-gradient-to-r from-teal-600/20 to-blue-600/20 border-teal-500/50">
        <CardContent className="p-6">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-2">
                <Star className="h-5 w-5 text-yellow-400" />
                <h3 className="text-lg font-semibold text-white">Enhanced Portfolio Management Available!</h3>
              </div>
              <p className="text-gray-300 text-sm mb-3">
                Create rich, dynamic project detail pages with our new enhanced admin panel. 
                Add key results, technologies, timeline, testimonials, and image galleries.
              </p>
              <div className="flex flex-wrap gap-2">
                {['Rich Content', 'Media Gallery', 'Timeline', 'Testimonials', 'Tech Stack'].map((feature) => (
                  <Badge key={feature} variant="outline" className="text-teal-300 border-teal-300">
                    {feature}
                  </Badge>
                ))}
              </div>
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              <Button 
                onClick={() => window.open('/admin/portfolio-enhanced', '_blank')} 
              ...
              <Button 
                variant="outline" 
                onClick={() => window.location.href = '/admin/portfolio-enhanced'}
              >
                Switch to Enhanced
              </Button>
            </div>
