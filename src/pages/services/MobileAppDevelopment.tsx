...
import { CheckCircle, Download, Users, Star, Shield } from "lucide-react";
                ...
                <div className="space-y-4">
                  <div className="bg-[#111528] rounded-xl p-4 shadow-[0_20px_48px_rgba(0,0,0,0.4)] border border-[#1C2333] transform rotate-3 hover:rotate-0 transition-transform duration-300">
                    <div className="w-full h-32 rounded-lg mb-3 flex items-center justify-center overflow-hidden">
                      <img src={mobileImg} alt="E-Commerce App" className="object-cover w-full h-full rounded-lg" />
                    </div>
                  ...
                  <div className="bg-[#111528] rounded-xl p-4 shadow-[0_20px_48px_rgba(0,0,0,0.4)] border border-[#1C2333] transform -rotate-2 hover:rotate-0 transition-transform duration-300">
                    <div className="w-full h-24 rounded-lg mb-3 flex items-center justify-center overflow-hidden">
                      <img src={uiImg} alt="Business App" className="object-cover w-full h-full rounded-lg" />
                    </div>
                ...
                <div className="space-y-4 mt-8">
                  <div className="bg-[#111528] rounded-xl p-4 shadow-[0_20px_48px_rgba(0,0,0,0.4)] border border-[#1C2333] transform -rotate-3 hover:rotate-0 transition-transform duration-300">
                    <div className="w-full h-28 rounded-lg mb-3 flex items-center justify-center overflow-hidden">
                      <img src={webImg} alt="Social App" className="object-cover w-full h-full rounded-lg" />
                    </div>
                  ...
                  <div className="bg-[#111528] rounded-xl p-4 shadow-[0_20px_48px_rgba(0,0,0,0.4)] border border-[#1C2333] transform rotate-2 hover:rotate-0 transition-transform duration-300">
                    <div className="w-full h-20 rounded-lg mb-3 flex items-center justify-center overflow-hidden">
                      <img src={gameImg} alt="Education App" className="object-cover w-full h-full rounded-lg" />
                    </div>
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-12">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
              ...
              <div className="text-center lg:text-left flex-1">
                <h3 className="font-heading text-3xl md:text-4xl font-bold text-orange-300 mb-4 drop-shadow-[0_4px_20px_rgba(255,120,73,0.3)]">
                  Ready to start?
                </h3>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-6">
                ...
                <Button
                  size="lg"
                  className="bg-gradient-to-r from-orange-500 to-orange-400 hover:from-orange-400 hover:to-orange-300 text-black text-lg font-semibold px-8 py-4 rounded-xl shadow-[0_15px_50px_rgba(255,120,73,0.25)] hover:shadow-[0_20px_60px_rgba(255,120,73,0.35)] transition-all duration-300 hover:-translate-y-1"
