...
cloudinary.config({
  cloud_name: 'drtybovzy',
  api_key: 274389356699477,
  api_secret: 'bYXYSS_VwLwv8SqOanlplr_nqG0',
});
...
// @access  Private (Admin/Editor)
router.post('/images', protect, authorize('admin', 'editor'), upload.array('images', 10), async (req, res) => {
  try {
...
// @access  Private (Admin/Editor)
router.get('/files', protect, authorize('admin', 'editor'), async (req, res) => {
  try {
